...
function initClientAndJoinChannel(agoraAppId, channelName, name) {
  // init Agora SDK
  client.init(agoraAppId, function () {
    console.log("AgoraRTC client initialized");
    joinChannel(channelName, name); // join channel upon successfull init
  }, function (err) {
...
// join a channel
function joinChannel(channelName, user_id) {
  var token = generateToken();
  var userID = user_id; // set to null to auto generate uid on successfull connection
...
function addRemoteStreamMiniView(remoteStream){
  ...
  $('#remote-streams').append(
    $('<div/>', {'id': streamId + '_container',  'class': 'remote-stream-container'}).append(
      $('<div/>', {'id': streamId + '_name', 'class': 'mini-video-name'}).append(
          streamId.replace("_", " ").toUpperCase()
      ),
